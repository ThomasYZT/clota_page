export default {
    //查询景区工作台各项
    'workbench-queryScenicWorkbenchOptions' : '/workbench/queryScenicWorkbenchOptions',
    //查询各类别待处理事项量
    'workbench-getWorkBackByClassify' : '/workbench/getWorkBacklogNumGroupByClassify',
    //查询景区畅销产品
    'workbench-getGoodSaleProduct' : '/workbench/getSaleQuantityEchartOptionData',
    //查询景区营业状况
