    ...
    <div class="charge-account-info">
        ...
        <ul class="table-wrap">
            ...
            <li class="wrap-li">
                ...
                <span class="label-value">
                    {{ chargeInfo.corpusBalance | moneyFilter | contentFilter }} {{(chargeInfo.accountDefineId === '1' || chargeInfo.accountDefineId === '4') ? $t('yuan') : $t(chargeInfo.unit)}}
                </span>
            </li>
            <li class="wrap-li" v-if="chargeInfo.accountDefineId !== '4'">
                <span class="label-key">{{$t('colonSetting' , { key : $t('giftSum') })}}</span>
                <span class="label-value">
                    {{ chargeInfo.donateBalance | moneyFilter | contentFilter }} {{(chargeInfo.accountDefineId === '1' || chargeInfo.accountDefineId === '4') ? $t('yuan') : $t(chargeInfo.unit)}}
                </span>
            </li>
        </ul>
