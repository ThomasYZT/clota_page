...
export default {
    ...
    "productNameAndReserveNum" : "产品名称/预订数量",
    ...
    "birthdayRights" : "生日当天限购{num}张{discount}折门票",
    ...
    "todayReserveNum" : "今日预订人数",
    "todayReserveQty" : "今日预订数量",
    ...
    "product.needId.one" : "每个证件只能预订一张票",
    "product.needId.more" : "每个证件可预订多张票",
    "waitToSync" : "-",
    ...
    "privalige.market-withdraw" : "提现记录",
    ...
    "productCenter.refundTip1" : "1、当手续费率为1时，不允许申请退票。",
    "productCenter.refundTip2" : "2、未设置手续费率的期限内，默认不允许申请退票。",
    "productCenter.refundTip3" : "3、退票手续费为：产品单价×手续费率×退票数量。",
    "oldPassword" : "旧密码",
    "surePassword" : "确认密码",
    ...
    "A012" : "重置密码太过频繁，请稍后再试",
    "returnRuleNotAllowMsg" : "提示：您申请退票的产品中包含按产品规则不允许退票的产品，是否继续申请？",
    ...
    "M055" : "存在支付即会员规则",
    "M056" : "无推送卡级",
    "teamOrderAudit" : "团队订单审核",
    "M022" : "密码卡未设置密码",
    "serviceInit" : "服务初始化配置",
    "serviceAccountType" : "已开通会员-储值服务，储值账户类型：",
    "serviceCardType" : "已开通会员相关服务，会员卡相关配置：",
    "upgradePoint" : "升级金额是指从当前级别升入下一级别，需要达到的累计销售金额。",
    "trading" : "交易正在进行中…",
    "moreAccount" : "多账户",
    "waitScan" : "等待扫码中…",
    "getFocus" : "扫码前，请获取焦点",
    "growthAndSaleCard" : "成长型+售卖型",
    "tradeCancel" : "交易已取消！",
    "unknowResult" : "交易结果未知！",
    "tradeFail" : "交易失败!",
    ...
    "reissueCardRecord" : "补卡记录",
    "openCardRecord" : "开卡记录",
    "refundCardRecord" : "退卡记录",
    "batchOpenCardRecord" : "批量开卡记录",
    "pleaseConfigWxCorrectly" : "请正确配置微信公众号信息",
    "personal" : "个人",
    "enterprise" : "企业",
    "oneLevelGrade" : "1级为最低等级",
    "canGo" : "可前往",
    "goForResult" : "继续查询支付结果",
    "ticket1" : "票类1",
    "tourist1" : "游客姓名1",
    "ticket2" : "票类2",
    "tourist2" : "游客姓名2",
    ...
    "comma" : "，",
    "themeSkin" : "主题皮肤",
    "memberRechargeNotificationTemplateID" : "会员充值通知模版ID",
    "consumptionSuccessNotificationTemplateID" : "消费成功通知模版ID",
    "getIDFromWechat" : "请在微信公众号后台获取ID",
    "payGiftCardSetting" : "支付即会员默认推送会员卡设置",
    "membershipCardToBePushed" : "要推送的会员卡",
    "pleaseConfigureCardInformation" : "请先配置卡包卡面信息",
    "noCardLevel" : "无会员卡级别",
    "wxCardInfo" : "微信卡包卡面信息",
    "cardLogo" : "会员卡logo",
    "uploadSuggest" : "建议像素300*300",
    "businessName" : "商户名称",
    "businessNameSetTip" : "保存后不可更改，请谨慎填写。",
    "cardCoverImg" : "卡劵封面图片",
    ...
    "ban" : "禁止",
    "makePoster" : "制作海报",
    "payResultError" : "支付结果未知，如果已支付，请联系合作伙伴。",
    "frontPage" : "正面",
    "specialEmployeeDesc" : "限制订单可用范围，只可查询/操作该员工创建的订单",
    "reverseSide" : "反面",
    "fullFacePhoto" : "正面照",
    "reverseFacePhoto" : "反面照",
    "scenicResource" : "景区资源",
    "plantformNoSetAccountErr" : "平台暂未配置在线收款账户，请联系客服",
    "cancelAfterVerify" : "过期自动核销",
    "noticeInPark" : "入园须知",
    "chooseLongitudeAndLatitude" : "选择经纬度",
    "bringUpQuota" : "调出配额",
    "appointedDay" : "指定日期",
    "addType" : "添加类别",
    "productLabel" : "产品标签",
    ...
    "management" : "管理",
    "maxAddTwoPersonSaleCard" : "最多新增2张售卖型个人会员卡",
    "maxAddTwoCompanySaleCard" : "最多新增2张售卖型企业会员卡",
    "maxAddTwoPersonGrowthCard" : "最多新增2张成长型型个人会员卡",
    "maxAddTwoCompanyGrowthCard" : "最多新增2张成长型型企业会员卡",
    "coverPage" : "封面",
    "carousel" : "轮播",
    "setToCover" : "设为封面",
    "cancelCover" : "取消封面",
    "addToCover" : "加入轮播",
    "sureToDeletePic" : "是否确认删除图片",
    "deleteResource" : "删除资源",
    "cancelCarousel" : "取消轮播",
    "uploadScenicResourceFaield" : "景区资源上传失败",
    "uploadScenicResourceSuccessfully" : "景区资源上传成功",
    "payerLackOfCredit" : "付款账户可用额度不足",
    "choosePosterBasePic" : "请选择海报底图",
    "chosePosterPicTypeOne" : "方式1：从已上传的海报图片中选择",
    ...
    "dataAuthority" : "数据权限",
    "quotaSetting" : "配额设置",
    "limitationOfQuotas" : "限制配额方式",
    "quotaOfProduct" : "产品配额数量",
    "descOfProductQuota" : "说明：产品配额数量是指该产品在本销售政策中的配额总量或每日配额数量。",
    "sharedQuota" : "共享配额数量",
    "descOfProductShareQuota" : "说明：共享配额数量是指各个销售渠道（不含全民营销）在消耗完专享配额之后，可继续消耗的共享配额部分。",
    "marketQuota" : "全民营销配额数量",
    "descOfProductMarketQuota" : "说明：全民营销配额数量指定给全民营销所有销售用户的配额。",
    "allowableQuotaQuantity" : "可分配配额数量",
    "exceeding" : "超出{field}",
    ...
    "saveSetting" : "保存设置",
    "quantityOfRedeploymentQuotas" : "调出配额数量",
    "quantityOfInputQuota" : "调入配额数量",
    "callOut" : "调出",
    "callIn" : "调入",
    "adjustableQuantity" : "可调配数量",
    "salePolicyDateError" : "销售政策不在售卖日期内，无法调配配额",
    "callInQuota" : "调入配额",
    "callOutQuota" : "调出配额",
    "confirmTo" : "确认{msg}",
    "channelFormShareToNow" : "从共享配额调入本渠道",
    "callOutToShare" : "调出至共享配额",
    "consumptionQuota" : "消耗配额",
    "vipQuotaRest" : "专享配额余量",
    "vipQuota" : "渠道专享配额",
    "choseChannel" : "选择渠道",
    "limitOfQuota" : "配额限制方式",
    "quotaQuatity" : "配额数量",
    "checkQuota" : "查看配额",
    "noEnterTip" : "该园区暂无入园须知",
    "deleteProductTag" : "删除产品标签",
    "tagsLimit" : "最多只能添加3个标签",
    "addTag" : "新增标签",
    "deleteTagsTip" : "以下{{length}}个产品正在使用这些标签，确定要删除这些标签吗？",
    "productTypeManage" : "产品类别管理",
    "productTypeIsUsingTip" : "该类别正在使用，不能删除",
    "originalPrice" : "原价",
    "carbons" : "副本",
    "explain" : "说明",
    "pictureSize" : "图片尺寸",
    "imgFile" : "图片文件",
    "sizeNotExceeding" : "{field}大小不超过{size}",
    "productEffSetTip1" : "游玩日期之日起M天有效：是指产品必须在下单时指定的游玩日期核销，在首次核销之后的M天可多次入园游玩。",
    ...
    'wxOrderDetail' : '微信订单详情',
    'aliOrderDetail' : '支付宝订单详情',
    'trade' : '交易',
    'networkError' : '网络错误，请稍后再试！',
    'pullPaymentDesc' : '1、根据微信和支付宝的对账单生成规则，系统每天10:10更新前一天的交易记录',
    'recipAccount' : '对方账户',
    'merOrderNum' : '商户订单号',
    'payNumber' : '支付单号',
    'refundNumber' : '退款单号',
    ...
    'payScene' : '支付场景',
    'tradeStatus' : '交易状态',
    'wxPay.JSAPI' : 'JSAPI支付（或小程序支付）',
    'wxPay.NATIVE' : 'Native支付',
    'wxPay.APP' : 'app支付',
    'wxPay.MWEB' : 'H5支付',
    'wxPay.MICROPAY' : '付款码支付',
    'wxPayRe.SUCCESS' : '支付成功',
    'wxPayRe.REFUND' : '转入退款',
    'wxPayRe.NOTPAY' : '未支付',
    'wxPayRe.CLOSED' : '已关闭',
    'wxPayRe.REVOKED' : '已撤销',
    ...
    'validCard' : '有效卡券',
    'invalidCard' : '无效卡券',
    'communicationCoupon' : '传播型优惠券',
    'memberBenefitCoupon' : '会员权益优惠券',
    'couponNameV2' : '优惠券名称',
    'couponTypeV2' : '优惠券类型',
    'createdDateTime' : '创建日期',
    'viewCouponCode' : '查看券码',
    'exportCouponCode' : '导出券码',
    'generateLink' : '生成链接',
    'manualPush' : '手动推送',
    'restart' : '重启',
    'exportRecord' : '导出记录',
    'generateLinkRecord' : '生成链接记录',
    'benefitCouponPushRecord' : '会员权益优惠券推送记录',
    'addGood' : '新增商品',
    'goodID' : '商品ID',
    'operateRecord' : '操作记录',
    'exportCouponRecord' : '导出卡券记录',
    'exportTime' : '导出时间',
    'exportNum' : '导出数量',
    'recipientInformation' : '领取人信息',
    'filePassword' : '文件密码',
    'generationTime' : '生成时间',
    'generationNum' : '生成数量',
    'founder' : '创建人',
    ...
    'coupon.status.nouse' : '未使用',
    'coupon.status.exchange' : '已兑换',
    'coupon.status.unknow' : '未知',
    'M059' : '卡券不足',
    'createdRule' : '新建规则',
    'validDate' : '生效日期',
    ...
    'effdaysComputed' : '从发放至游客开始计算有效期',
    '0MeansNoLimit' : '0代表不限制',
    'totalGainTip' : '该设置只限制将优惠券生成链接传播时限制领取数量。积分商城、批量导出部分不受该设置限制',
    'availableShop' : '可用店铺',
    'effectiveTime' : '有效期',
    'availableProductCategories' : '可用产品类别',
    'spreadUsage' : '传播型主要用于：创建创建一定数量的优惠券后将优惠券进行生成链接、批量导出、上架积分商城',
    'rightUsage' : '会员权益型主要用于：将创建的该类型优惠券通过自动或手动的形式发放至会员名下，该类型优惠券不可进行传播',
    'pushRecord' : '推送卡级记录',
    ...
    'valid' : '有效',
    'inValid' : '无效',
    'exchangableGood' : '可兑换商品',
    'couponDiscount' : '卡券折扣',
    'changer' : '兑换人',
    'chargerPhoneNum' : '兑换人手机号',
    'useTime' : '使用时间',
    'recipient' : '领取人',
    'recipientPhoneNum' : '领取人手机号',
    'recipientPhone' : '领取人电话',
    'recieveTime' : '领取时间',
    'recipient&charger' : '领取/兑换人',
    'recipient&chargerPhone' : '领取/兑换人手机号',
    'gain&charge' : '领取/兑换',
    'charge&gainTime' : '兑换/领取时间',
    'useOrNot' : '是否使用',
    'ticketYard' : '券码',
    'sureToPush' : '是否确定推送?',
    'push' : '推送',
    'generatedQuantity' : '可生成数量',
    'urLink' : '链接地址',
    'generate' : '生成',
    'sureToObsolete' : '是否确定作废本次优惠券?',
    'isContinuesEffective' : '已兑换、已领取的卡券是否继续有效：',
    'continuesEffective' : '继续有效',
    'allFailed' : '全部失效',
    'obsoleteTip' : '如果选择失效则本批次所有未使用的卡券均失效',
    'H5BGSet' : 'H5页面背景设置',
    'exportableQuantity' : '可导出数量',
    'isEncrypted' : '导出文件是否加密',
    'encryption' : '加密',
    'notEncrypted' : '不加密',
    ...
    'memberPointDiscountSetting' : '会员积分、折扣率设置',
    'copyRule' : '复制规则',
    'forever' : '永久',
    'effecting' : '生效中',
    'invalid' : '未生效',
    ...
    'ruleStatus' : '规则状态',
    'stautsHasStoped' : '{name}已暂停',
    'statusStopedFailed' : '{name}暂停失败',
    'statusEnabled' : '{name}已启用',
    'statusEnabledFailed' : '{name}启用失败',
