...
export default {
    ...
    "order.self_channel" : "Self-operated channel",
    ...
    "privalige.market-withdraw" : "Cash record",
    ...
    "callOutToShare" : "Call out to shared quota",
    ...
    "addTag" : "Add tag",
    "deleteTagsTip" : "These labels are in use in the following {length} products, are you sure you want to delete them?",
    ...
    "productEffSetTip2" : "Same as the play period applied to sales policy: within the specified period of the sales policy, any day can be written off. Not applicable to team products, not limited to daily stock.",
    "province" : "Province",
    "city" : "City",
    "area" : "Area",
    ...
    'specialIntegralSetting' : 'Special credit discount rate setting',
    'coupon' : 'Coupon',
    'cardCoupon' : 'Card coupon',
    'cardReport' : 'Card Report',
    'memberGoodsManage' : 'Commodity management',
    'couponCodeDetails' : 'Coupon voucher code details',
    'couponUsageDetails' : 'Coupon usage details',
    'exportMemberInfo' : 'Export data this time: {num} | Export data this time: {num}',
    'H5Setting' : 'Coupon collection H5 page background setting',
    'applicationScenario' : 'Application scenario',
    'wetherEffective' : 'Is it valid',
    'validCard' : 'Valid card coupon',
    'invalidCard' : 'Invalid card coupon',
    'communicationCoupon' : 'Propagation coupon',
    'memberBenefitCoupon' : 'Membership Coupon',
    'couponNameV2' : 'Coupon name',
    'couponTypeV2' : 'Coupon category',
    'createdDateTime' : 'Create date',
    'viewCouponCode' : 'View coupon code',
    'exportCouponCode' : 'Export coupon code',
    'generateLink' : 'Generate link',
    'manualPush' : 'Manual push',
    'restart' : 'Restart',
    'exportRecord' : 'Export record',
    'generateLinkRecord' : 'Generate link record',
    'benefitCouponPushRecord' : 'Membership Coupon Push Record',
    'addGood' : 'Add item',
    'goodID' : 'Item ID',
    'operateRecord' : 'Operation record',
    'exportCouponRecord' : 'Export card ticket record',
    'exportTime' : 'Export time',
    'exportNum' : 'Export quantity',
    'recipientInformation' : 'Recipient information',
    'filePassword' : 'File password',
    'generationTime' : 'Generation time',
    'generationNum' : 'Generate quantity',
    'founder' : 'Creator',
    'links' : 'Link',
    'pushTime' : 'Push time',
    ...
    'amountSingleDay' : 'Amount can be received in a single day',
    'amountLimit' : 'Maximum number of available',
    'onlyInput' : 'Can only enter {field}',
    'letter' : 'Letter',
    'number' : 'Number',
    'coupon.spread' : 'Propagation type',
    'coupon.right' : 'Equity',
    'coupon.status.wait' : 'Not received',
    'coupon.status.occupy' : 'Not received',
    'coupon.status.receive' : 'Received',
    'coupon.status.used' : 'Already used',
    'coupon.status.nouse' : 'Unused',
    'coupon.status.exchange' : 'Has been redeemed',
    'coupon.status.unknow' : 'Unknown',
    'M059' : 'Insufficient card coupons',
    'createdRule' : 'New rule',
    'validDate' : 'Effective date',
    'validDateEveryDay' : 'Daily effective time',
    'M061' : 'The effective time range overlaps, please modify the time range',
    'memberCardCategory' : 'Member card category',
    ...
    'effdaysComputed' : 'Calculate the validity period from the issuance to the visitor',
    '0MeansNoLimit' : '0 means no limit',
    'totalGainTip' : 'This setting only limits the number of recipients when the coupon generation link is propagated. Points Mall, Bulk Export is not subject to this setting',
    'availableShop' : 'Available shop',
    'effectiveTime' : 'Validity period',
    'availableProductCategories' : 'Available product categories',
    'spreadUsage' : 'Propagation type is mainly used to: create a certain number of coupons, then generate coupons for coupons, bulk export, and put on points malls',
    'rightUsage' : 'Membership type is mainly used to: the created coupon of this type is automatically or manually issued to the member name, this type of coupon can not be spread',
    'pushRecord' : 'Push card level record',
    'couponUseRecord' : 'Coupon usage record',
    'couponStatus' : 'Coupon status',
    'couponCode' : 'Coupon voucher code',
    'valid' : 'Valid',
    'inValid' : 'Invalid',
    'exchangableGood' : 'Convertible goods',
    'couponDiscount' : 'Card coupon discount',
    'changer' : 'Exchanger',
    'chargerPhoneNum' : 'Exchanger\'s mobile number',
    'useTime' : 'Use time',
    'recipient' : 'Recipient',
    'recipientPhoneNum' : 'Recipient\'s mobile number',
    'recipientPhone' : 'Recipient\'s phone',
    'recieveTime' : 'Receive time',
    'recipient&charger' : 'Receive/exchanger',
    'recipient&chargerPhone' : 'Receive / redeem phone number',
    'gain&charge' : 'Receive/Exchange',
    'charge&gainTime' : 'Exchange/Receive Time',
    'useOrNot' : 'Whether to use',
    'ticketYard' : 'Coupon code',
    'sureToPush' : 'Are you sure to push?',
    'push' : 'Push',
    'generatedQuantity' : 'Can generate quantity',
    'urLink' : 'Link address',
    'generate' : 'Generate',
    'sureToObsolete' : 'Are you sure to void this coupon?',
    'isContinuesEffective' : 'Is the redeemed, received card coupon valid?',
    'continuesEffective' : 'Continue effective',
    'allFailed' : 'All failed',
    'obsoleteTip' : 'If the selection is invalid, all unused card coupons in this batch will be invalid',
    'H5BGSet' : 'H5 page background setting',
    'exportableQuantity' : 'Exportable quantity',
    'isEncrypted' : 'Is the export file encrypted?',
    ...
    'endConsumeBiggerThanStartConsume' : 'The maximum consumption amount is greater than the minimum consumption amount',
    'memberPointDiscountSetting' : 'Member points, discount rate settings',
    'copyRule' : 'Copy rule',
    'forever' : 'permanent',
    'effecting' : 'In effect',
    'invalid' : 'Not active',
    'valided' : 'Expired',
    'setDiscountByMemberCard' : 'Set points and discount rates by membership card level',
    'pause' : 'pause',
    'confirmDeleteRule' : 'Are you sure you want to delete the rule?',
    'ruleStatus' : 'Rule status',
    'stautsHasStoped' : '{name} has been suspended',
    'statusStopedFailed' : '{name} pause failed',
    'statusEnabled' : '{name} is enabled',
    'statusEnabledFailed' : '{name} enabled failed',
    'ruleDeleted' : '{name} has been deleted',
    'ruleDeletedFailed' : '{name} failed to delete',
    'M060' : 'Product ID repeat',
    'receive' : 'receive',
